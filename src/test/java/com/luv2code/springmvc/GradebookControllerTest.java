...
public class GradebookControllerTest {
    ...
    public static void setUp(){
        ...
        request.setParameter("emailAddress","test@mail.co");
    }
    ...
    public void getStudentsHttpRequest() throws Exception{
        // add the new student
        student.setFirstname("Kubilay");
        student.setLastname("kubiSurname");
        student.setEmailAddress("kubi@test.co");
        // add the db and refresh
    ...
    public void createStudentHttpRequest() throws Exception{
        ...
        student.setEmailAddress("test@mail.co");

        mockMvc.perform(post("/")
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(student))) // java obj to json
                .andExpect(status().isOk())
                .andExpect(jsonPath("$",hasSize(2)));

        CollegeStudent verifyStudent = studentDao.findByEmailAddress("test@mail.co");
        assertNotNull(verifyStudent,"student should be valid");
    }

    @Test
    public void deleteStudentHttpRequst() throws Exception{
